...
public class RequestService {
	 ...
	 * @param conn
	 */
	public void receive(String request, BaseConnection<?> conn) {
	 ...
	 * @param conn
	 */
	public void processGeneralRequest(String request, BaseConnection<?> conn) {		
		if (conn == null) {
		...
		RequestUtils.setCurrentConn(conn);
	...
	private class ReceiveTask implements Runnable {
		...
		public ReceiveTask(String request, BaseConnection<?> conn) {
