...
public class StatusRemote extends StatusServiceProxy {
    ...
    *通过Id 取得多个Session信息
    */
    public com.pengpeng.stargame.rpc.Session[] getSomeSession (com.pengpeng.stargame.rpc.Session pid, java.lang.String[] arr$ ){
      com.pengpeng.stargame.rpc.Session[]  rValue=  execute("status.get.somesession",pid, gson.toJson(arr$),com.pengpeng.stargame.rpc.Session[].class);
      return rValue;
     }
    /**
    *取得token
