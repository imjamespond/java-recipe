...
public class RedisDemo
{
    ...
    private void initialPool()
    {
       ...
       // config.setDemoOnBorrow(false);

        jedisPool = new JedisPool(config, "192.168.10.125", 6379);
    }
    ...
    private void initialShardedPool()
    {
      ...
      //  config.setDemoOnBorrow(false);
        ...
        shards.add(new JedisShardInfo("192.168.10.125", 6379, "master"));
    ...
    private void testList()
    {
        ...
        // 数组长度
 //       System.out.println("数组长度:"+shardedJedis.llen("lists"));
        // 排序
        System.out.println(shardedJedis.sort("lists"));
        // 字串
        System.out.println("字串:"+shardedJedis.lrange("lists", 0, 3));
        // 修改列表中单个值
