...
public class GameServer {
	private static Log logger = LogFactory.getLog(GameServer.class);

	public GameServer(){
		
	}
	public static void main(String[] args) throws UnknownHostException{
		ClassPathXmlApplicationContext context = new ClassPathXmlApplicationContext(new String[]{"context-gameserver.xml"});
...
//        }
	...
	public static void startGameServer(final SimpleChannelHandler handler){
...
//      bootstrap.getPipeline().addLast("encoder", new StringEncoder(Charset.forName("UTF-8")));
	...
	public static void startSecurityServer(final ApplicationContext ctx){
    	NioServerSocketChannelFactory factory = new NioServerSocketChannelFactory(Executors
                .newCachedThreadPool(), Executors.newCachedThreadPool());
        ServerBootstrap bootstrap = new ServerBootstrap(factory);
