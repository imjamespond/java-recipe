...
*查询物品的数量
*/
public GoodsVO goodsNum (com.pengpeng.stargame.rpc.Session session, com.pengpeng.stargame.vo.farm.FarmIdReq req ) throws GameException{
    GoodsVO  rValue=  proxy.execute("farm.goodsNum",session, proxy.gson.toJson(req),GoodsVO.class);
      return rValue;
}
/**
*卖出一些物品
*/
public com.pengpeng.stargame.vo.farm.FarmPkgVO saleItemsome (com.pengpeng.stargame.rpc.Session tid, com.pengpeng.stargame.vo.farm.FarmItemReq arr$ ) throws GameException{
      com.pengpeng.stargame.vo.farm.FarmPkgVO  rValue=  proxy.execute("farmpkg.removeSome",tid, proxy.gson.toJson(arr$),com.pengpeng.stargame.vo.farm.FarmPkgVO.class);
      return rValue;
}
/**
*整理背包
*/
public com.pengpeng.stargame.vo.farm.FarmPkgVO clearup (com.pengpeng.stargame.rpc.Session farmItem, com.pengpeng.stargame.vo.farm.FarmItemReq itemId ) throws GameException{
      com.pengpeng.stargame.vo.farm.FarmPkgVO  rValue=  proxy.execute("farmpkg.clearup",farmItem, proxy.gson.toJson(itemId),com.pengpeng.stargame.vo.farm.FarmPkgVO.class);
      return rValue;
}
