...
*取得亲妈农场装饰信息
*/
public com.pengpeng.stargame.vo.farm.decorate.FarmDecorateVO getFarmDecorateInfo (com.pengpeng.stargame.rpc.Session session, com.pengpeng.stargame.vo.farm.FarmIdReq req ) throws GameException{
      com.pengpeng.stargame.vo.farm.decorate.FarmDecorateVO  rValue=  proxy.execute("farm.qinma.decorate.info",session, proxy.gson.toJson(req),com.pengpeng.stargame.vo.farm.decorate.FarmDecorateVO.class);
      return rValue;
}
/**
*取得亲妈农场信息
