...
*一键收获所有作物
*/
public void harvestAll (com.pengpeng.stargame.rpc.Session session, com.pengpeng.stargame.vo.farm.FarmIdReq req ) throws GameException{
     proxy.execute("farm.harvestAll",session, proxy.gson.toJson(req),void.class);
...
*加速生长
*/
public FarmSpeedVO speedup (com.pengpeng.stargame.rpc.Session session, com.pengpeng.stargame.vo.farm.FarmIdReq req ) throws GameException{
      FarmSpeedVO  rValue=  proxy.execute("farm.speedup",session, proxy.gson.toJson(req),FarmSpeedVO.class);
      return rValue;
}
/**
*帮助好友一键收获所有作物
*/
public void friendHarvestAll (com.pengpeng.stargame.rpc.Session session, com.pengpeng.stargame.vo.farm.FarmIdReq req ) throws GameException{
     proxy.execute("farm.friend.harvestAll",session, proxy.gson.toJson(req),void.class);
    
}
/**
*直接催熟需要的达人币
*/
public int speedupNeedGold (com.pengpeng.stargame.rpc.Session session, com.pengpeng.stargame.vo.farm.FarmIdReq req ) throws GameException{
      int  rValue=  proxy.execute("farm.speedup.needGold",session, proxy.gson.toJson(req),int.class);
      return rValue;
}
