...
*好友顶置
*/
public void topFriend (com.pengpeng.stargame.rpc.Session session, com.pengpeng.stargame.vo.IdReq req ) throws GameException{
     proxy.execute("friend.top",session, proxy.gson.toJson(req),void.class);
    
}
/**
*取消好友顶置
*/
public void cancelTopFriend (com.pengpeng.stargame.rpc.Session session, com.pengpeng.stargame.vo.IdReq req ) throws GameException{
     proxy.execute("friend.cancel.top",session, proxy.gson.toJson(req),void.class);
