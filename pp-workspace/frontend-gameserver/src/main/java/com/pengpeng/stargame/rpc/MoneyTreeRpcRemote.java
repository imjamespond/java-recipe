...
*获取所有家族Id列表
*/
public java.lang.String[] getFamilyIds (com.pengpeng.stargame.rpc.Session session, com.pengpeng.stargame.vo.piazza.MoneyTreeReq req ) throws GameException{
      java.lang.String[]  rValue=  proxy.execute("moneytree.getFamilyIds",session, proxy.gson.toJson(req),java.lang.String[].class);
      return rValue;
}
/**
*获取摇钱树的提示信息
