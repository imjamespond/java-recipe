...
*领取(接受)礼物
*/
public void accept (com.pengpeng.stargame.rpc.Session rule, com.pengpeng.stargame.vo.role.GiftReq fashionPkg ) throws GameException{
     proxy.execute("fashion.gift.accept",rule, proxy.gson.toJson(fashionPkg),void.class);
