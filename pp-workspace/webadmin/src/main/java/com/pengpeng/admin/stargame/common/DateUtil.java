package com.pengpeng.admin.stargame.common;
...
public class DateUtil {
	 ...
	 * @param dateFmt 转换格式
	 * @return
	 * @throws java.text.ParseException If the string and the format is not match, exception will be thrown
	 */
    ...
    public static Date toDate(String dateStr, String dateFmt) {
        SimpleDateFormat format = new SimpleDateFormat(dateFmt);
        try {
            return format.parse(dateStr.trim());
        } catch (ParseException e) {
