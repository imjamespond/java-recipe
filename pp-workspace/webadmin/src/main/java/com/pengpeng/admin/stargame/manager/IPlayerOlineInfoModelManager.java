...
public interface IPlayerOlineInfoModelManager{
	
	public PlayerOlineInfoModel createBean(PlayerOlineInfoModel playerOlineInfoModel) throws BeanAreadyException;
	...
	public Page<PlayerOlineInfoModel> findPages(Map<String,Object> params,int pageNo,int pageSize);
