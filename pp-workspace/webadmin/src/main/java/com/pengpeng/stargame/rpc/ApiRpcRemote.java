...
*充值VIP
*/
public void chargeVip (Session session, com.pengpeng.stargame.vo.role.ChargeReq req ) throws GameException{
...
*充值查询
*/
public java.util.List chargeInfo (Session dateKey, com.pengpeng.stargame.vo.role.ChargeReq i ) throws GameException{
      java.util.List  rValue=  proxy.execute("p.chargeInfo",dateKey, proxy.gson.toJson(i),java.util.List.class);
      return rValue;
}
