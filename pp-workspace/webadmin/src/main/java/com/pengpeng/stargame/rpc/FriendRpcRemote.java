...
*取得游戏内好友信息
*/
public com.pengpeng.stargame.vo.role.PlayerVO getFriendInfo (com.pengpeng.stargame.rpc.Session session, String friendId ) throws GameException{
...
*取得网站好友
*/
public com.pengpeng.stargame.vo.role.FriendVO[] getPPListFriend (com.pengpeng.stargame.rpc.Session session, String pid ) throws GameException{
      com.pengpeng.stargame.vo.role.FriendVO[]  rValue=  proxy.execute("friend.get.site",session, proxy.gson.toJson(pid),com.pengpeng.stargame.vo.role.FriendVO[].class);
      return rValue;
}
/**
*导入好友
...
*是否有好友需要审核
*/
public boolean applyFriend (com.pengpeng.stargame.rpc.Session session, String pid ) throws GameException{
...
*取得需要审核的申请列表
*/
public com.pengpeng.stargame.vo.role.FriendAuditVO[] getAuditFriend (com.pengpeng.stargame.rpc.Session i, String session ) throws GameException{
