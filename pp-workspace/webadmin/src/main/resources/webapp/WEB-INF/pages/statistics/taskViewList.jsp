...
<body>
<table id='playerTaskActionModel' class="easyui-datagrid" pagination="true" rownumbers="true"
...
<script type="text/javascript">
    ...
    function doSearch() {
        ...
        $('#playerTaskActionModel').datagrid({
            height:"auto",
            fit:true,
            idField:'id', method:'GET', url:'playerTaskActionModel/list/', queryParams:queryParams ,pagination:true, rownumbers:"true", fitColumns:"true", frozenColumns:[
                [
