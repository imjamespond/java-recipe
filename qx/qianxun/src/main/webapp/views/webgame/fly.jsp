...
<div class="wrapper">
    ...
    <noscript>
        <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="1280" height="768" id="Game">
            <param name="movie" value="/fly/Game.swf" />
            <param name="quality" value="high" />
            <param name="bgcolor" value="#01254a" />
            <param name="allowScriptAccess" value="sameDomain" />
            <param name="allowFullScreen" value="true" />
            <object type="application/x-shockwave-flash" data="/fly/Game.swf" width="1280" height="768">
                <param name="quality" value="high" />
                <param name="bgcolor" value="#01254a" />
                <param name="allowScriptAccess" value="sameDomain" />
                <param name="allowFullScreen" value="true" />
