...
public class GameCombat {
	...
	public static String combat(GameRoom game){
		...
		for(int i=0; i<3; i++){
			...
			if(null!=role0&&null!=role1){
				if(player0.petrify<turn)
					vo.getAnim0().add(CombatAnim(game, role0, role1, player0, player1));
				if(player1.petrify<turn)
					vo.getAnim1().add(CombatAnim(game, role1, role0, player1, player0));
	...
	public static GameAnimVO CombatAnim(GameRoom game, RoleData role0, RoleData role1, 
