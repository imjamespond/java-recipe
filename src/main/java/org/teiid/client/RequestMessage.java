...
public class RequestMessage implements Externalizable {
    ...
    public RequestMessage(String command) {
        ...
        Utils.PrintCaller((fileName, lineNum, methodName, thread)->{
            System.out.printf(" ===== [%s]%s(%d).%s, command: %s\n", thread, fileName, lineNum, methodName, command);
        });
    }
    ...
    public void setCommands(String... batchedCommands) {
        ...
        Utils.PrintCaller((fileName, lineNum, methodName, thread)->{
            System.out.printf(" ===== RequestMessage.setCommands [%s]%s(%d).%s, command: %s\n", thread, fileName, lineNum, methodName, String.join(",",batchedCommands));
        });
    }
    ...
    public void setCommand(Object command) {
        ...
        Utils.PrintCaller((fileName, lineNum, methodName, thread)->{
            System.out.printf(" ===== RequestMessage.setCommand [%s]%s(%d).%s, command: %s\n", thread, fileName, lineNum, methodName, command);
        });
    }
