...
public class CompositeVDB {
    ...
    private static TransformationMetadata buildTransformationMetaData(VDBMetaData vdb,
    	...
    	System.out.println("buildTransformationMetaDatabuildTransformationMetaDatabuildTransformationMetaDatabuildTransformationMetaDatabuildTransformationMetaDatabuildTransformationMetaData");
