...
public class TempTableStore {
    ...
    public TempMetadataStore getMetadataStore() {
        System.out.printf("TempTableStore::getMetadataStore\n");
    ...
    TempTable getTempTable(String tempTableID) {
        System.out.printf("TempTableStore::getTempTable %s %s\n", Utils.GetLastN(Thread.currentThread().getName(), 6),tempTableID);
...
//        System.out.printf("TempTableStore::getTempTable %s, command: %s\n", tempTableID, command);
